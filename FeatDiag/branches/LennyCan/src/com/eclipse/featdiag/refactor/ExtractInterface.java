...
//		try {
//			if (!RefactoringAvailabilityTester.isExtractInterfaceAvailable((IStructuredSelection) selection)) {
//				MessageDialog.openInformation(targetGraphicalViewer.getSite().getShell(), 
//						"Operation Not Applicable", "This operation can be performed on class or interface only.");
//				return;
//			}
...
//        ExtractInterfaceAction ra = new ExtractInterfaceAction(((DiagramEditor) targetGraphicalViewer).getSite());
