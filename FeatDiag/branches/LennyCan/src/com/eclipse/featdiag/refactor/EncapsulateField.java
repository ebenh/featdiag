...
public class EncapsulateField implements IEditorActionDelegate {
	...
	public void run(IAction action) {
		try {
			if (!RefactoringAvailabilityTester.isSelfEncapsulateAvailable((IStructuredSelection) selection)) {
        ...
        SelfEncapsulateFieldAction ra = new SelfEncapsulateFieldAction(((DiagramEditor) targetGraphicalViewer).getSite());
